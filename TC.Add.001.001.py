...
time.sleep(2)
element = driver.find_element(By.ID, "first-name").send_keys("hirta")
element = driver.find_element(By.ID, "last-name").send_keys("pamungkas")
element = driver.find_element(By.ID, "postal-code").send_keys("123456789")

time.sleep(2)
element = driver.find_element(By.ID, "continue").click()

time.sleep(2)
element = driver.find_element(By.ID, "finish").click()

time.sleep(2)
element = driver.find_element(By.ID, "back-to-products").click()
